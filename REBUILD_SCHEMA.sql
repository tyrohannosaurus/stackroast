-- ============================================
-- StackRoast Complete Database Schema
...
-- ============================================
-- Note: Supabase Auth may create the profiles table automatically
-- We'll create it if it doesn't exist, or add columns if it does
...
-- Add columns if table already existed (from Supabase Auth)
